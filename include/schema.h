...
extern bool schema_drop_column(Schema *schema, const Database *db, const char *col_name);
...
extern bool schema_add_constraint(Schema *schema, const Database *db, const Constraint *new_constraint);
